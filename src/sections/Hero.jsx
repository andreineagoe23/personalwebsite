      ...
      <div className="mx-auto w-full max-w-6xl px-5 sm:px-8">
        ...
        >
          <div className="lg:col-span-7">
            <m.div variants={fadeUp} className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <m.p variants={fadeUp} className="mt-6 font-mono text-sm tracking-tight text-muted">
              {profile.role}
            </m.p>
            ...
            <m.div variants={fadeUp} className="mt-10 flex flex-wrap items-center gap-3">
              <a
                href="#work"
          ...
          <m.div variants={fadeUp} className="lg:relative lg:col-span-5">
